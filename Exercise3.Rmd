...
alc <- select(math_por, all_of(grepl("(\\.math)|(\\.por)", colnames(math_por))))
...
g2 + geom_bar(aes(fill = sex)) + facet_wrap("sex")
...
alc %>% group_by(sex, high_use) %>% summarise(count = n(), mena_grade = mean(G3))
